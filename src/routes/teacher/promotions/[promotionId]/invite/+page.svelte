<!-- src/routes/teacher/promotions/[promotionId]/invite/+page.svelte -->
<script lang="ts">
...
<div class="container mx-auto p-4">
	...
	<Card.Root class="hidden px-4 py-2 md:block">
		...
		<Card.Content class="p-2 pt-0">
			...
			<div>
				...
				<Button class="w-full sm:w-auto">Add as New Student</Button>
			</div>
		</Card.Content>
	</Card.Root>
	...
	<div class="flex flex-col gap-8 md:hidden">
		...
		{/each}
		<Button variant="default" size="lg">Register new student</Button>
	</div>
</div>
